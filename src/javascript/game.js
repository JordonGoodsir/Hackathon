...
game = () => {   
    ...
    switch(clickCount) {   
        ...
        case 8: 
            game_message.innerHTML = "I mean no one will blame you, this is really difficult"  
        break; 
        ...
        case 11: 
            ...
            document.getElementsByClassName("game_buttons")[0].addEventListener("click", reload)
